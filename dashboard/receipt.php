...
<body  onload="window.print()">
    ...
    <section class="receipt">
        <?php
            ...
            $sel_ob = new SEL();
            $sel_con = $sel_ob->sel_recp($_GET['rd']);
        ...
        <div class="second-div-receipt">
            <p>Received from: <span><?php echo $row['customer_name']; ?></span> the amount of <span><?php echo '<strike>N</strike>'.number_format($row['amt_paid'],2); ?></span> for Payment of <span><?php echo $row['pur_pose']; ?></span> to <span><?php echo $row['writer_name']; ?></span></p>
        </div>
